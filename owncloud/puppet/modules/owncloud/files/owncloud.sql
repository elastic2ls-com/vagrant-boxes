...
INSERT INTO `oc_jobs` VALUES (1,'OCA\\Activity\\BackgroundJob\\EmailNotification','null',1437131671),(2,'OCA\\Activity\\BackgroundJob\\ExpireActivities','null',0),(3,'OCA\\Files_sharing\\Lib\\DeleteOrphanedSharesJob','null',0);
...
INSERT INTO `oc_mimetypes` VALUES (3,'application'),(4,'application/pdf'),(5,'application/vnd.oasis.opendocument.text'),(1,'httpd'),(2,'httpd/unix-directory'),(6,'image'),(7,'image/jpeg');
...
INSERT INTO `oc_preferences` VALUES ('admin','firstrunwizard','show','0'),('admin','login','lastLogin','1437131666');
...
INSERT INTO `oc_storages` VALUES ('home::admin',1),('local::/var/www/html/owncloud/data/',2);
...
INSERT INTO `oc_users` VALUES ('admin',NULL,'1|$2y$10$RhJHrdosCLpqWtX.XqAlk.w/72yakVMqAeBecmX2cXbCxA2rcy2ke');
...
-- Dump completed on 2015-07-17 13:15:55
